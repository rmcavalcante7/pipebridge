...
from pipebridge.dispatcher.field.fieldHandlerRegistry import FieldHandlerRegistry
...
class FieldDispatcher:
    ...
    def dispatch(self, card_id: str, field_id: str, field_type: str, value: Any) -> str:
        """
        ...
        return handler.buildMutation(card_id=card_id, field_id=field_id, value=value)
