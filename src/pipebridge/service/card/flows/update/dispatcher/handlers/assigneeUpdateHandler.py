...
class AssigneeUpdateHandler(BaseCardFieldUpdateHandler):
    """
    Resolve assignee field updates.
    """
    ...
    def resolve(
        ...
        """
        Resolve assignee updates into a list of Pipefy user identifiers.
        ...
        :raises ValidationError:
            When input is not a list of string identifiers
        """
        ...
        if not isinstance(input_value, list) or not all(
            ...
            raise ValidationError(
                message="Assignee fields require a list of string IDs",
