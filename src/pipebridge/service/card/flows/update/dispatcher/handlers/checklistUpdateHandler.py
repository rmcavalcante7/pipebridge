...
class ChecklistUpdateHandler(BaseCardFieldUpdateHandler):
    """
    Resolve checklist field updates.

    Checklist fields are modeled as a list of selected option strings.
    """
    ...
    def resolve(
        ...
        """
        Resolve checklist updates into a list of selected option strings.
        ...
        :raises ValidationError:
            When input is not a list of strings
        """
        ...
        if not isinstance(input_value, list) or not all(
            ...
            raise ValidationError(
                message="Checklist fields require a list of string values",
