...
class TextUpdateHandler(BaseCardFieldUpdateHandler):
    """
    Resolve text-like field updates.
    """
    ...
    def resolve(
        ...
        """
        Resolve text-like updates into a final string payload.
        ...
        if not isinstance(input_value, str):
            raise ValidationError(
                message="Text-like fields require a string value",
