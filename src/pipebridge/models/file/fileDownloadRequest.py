...
class FileDownloadRequest:
    ...
    def __init__(self, card_id: str, field_id: str, output_dir: str) -> None:
        """
        Initialize a validated file download request.

        :param card_id: str = Card identifier
        :param field_id: str = Attachment field identifier
        :param output_dir: str = Local output directory

        :raises ValidationError:
            When any argument is empty
        """
