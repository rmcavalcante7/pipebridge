...
class FieldRuleFactory:
    ...
    def createRule(self, config: Dict[str, Any]) -> FieldRule:
        """
...
class FieldRuleRegistry:
    ...
    def __init__(self) -> None:
        """
        Initialize an empty in-memory field rule registry.
        """
...
class FieldPermissionService:
    ...
    def __init__(self, registry: FieldRuleRegistry) -> None:
        """
        Initialize the field permission validation service.

        :param registry: FieldRuleRegistry = Source of permission rules
        """
    ...
    def _raisePermissionError(self, field_id: str, phase_id: str, reason: str) -> None:
        ...
        method_name = (
            frame.f_code.co_name if frame is not None else "_raisePermissionError"
        )
        raise FieldPermissionError(
            f"Class: {self.__class__.__name__}\n"
...
if __name__ == "__main__":
    ...
    config_rules: List[Dict[str, Any]] = [
        {"field_id": "field_1", "allowed_phases": ["phase_a", "phase_b"]},
        {"field_id": "field_2", "blocked_phases": ["phase_c"]},
    ]
